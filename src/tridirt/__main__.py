#!/usr/bin/env python3
"""tridirt - A launcher for Python versions of TrID, the file identifier."""
# Copyright (C) 2025 exurd
# Licensed under GNU AGPLv3. See bottom of code for license information.
